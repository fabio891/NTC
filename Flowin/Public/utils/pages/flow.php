...
<body class="text-slate-200 min-h-screen">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-slate-800 border-r border-slate-700 z-50 transition-transform duration-300 transform -translate-x-full md:translate-x-0">
        ...
        <nav class="mt-6 px-4 space-y-2">
            ...
            <a href="flow.html" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-orange-500/10 text-orange-500 border border-orange-500/20">
    ...
    <script>
        ...
        function viewDetails() {
            ...
            window.location.href = `produtos.html?codigo=${produtoAtual.codigo}`;
        }
