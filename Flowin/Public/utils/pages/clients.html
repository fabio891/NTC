...
<body class="text-slate-300 antialiased">
    ...
    <div class="relative min-h-screen md:flex">
        ...
        <!-- Sidebar -->
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a href="clients.html" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-orange-500/10 text-orange-500 border border-orange-500/20">
            ...
            <div class="p-4 sm:p-6 md:p-8">
                ...
                <div class="mt-6 bg-slate-800 rounded-lg">
                    <div class="px-6 py-4 border-b border-slate-700 flex items-center space-x-2">
                        ...
                        <h3 class="text-lg font-semibold text-white">Clientes Registados (<span id="clientes-count">0</span>)</h3>
                    </div>
        ...
        <div class="bg-slate-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
            ...
            <div class="flex-1 p-6 overflow-y-auto">
                 <form class="space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                     ...
                     <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" class="mt-1 w-full bg-slate-700 border border-slate-600 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-orange-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300">Telefone <span class="text-red-500">*</span></label>
                            <input type="tel" class="mt-1 w-full bg-slate-700 border border-slate-600 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-orange-500">
                        </div>
                    </div>
                     <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-300">BI/Passaporte</label>
                            <input type="text" class="mt-1 w-full bg-slate-700 border border-slate-600 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-orange-500">
                        </div>
                        <div>
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        <textarea rows="3" placeholder="Observações sobre o cliente..." class="mt-1 w-full bg-slate-700 border border-slate-600 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-orange-500"></textarea>
                    </div>
                 </form>
            </div>
             <div class="p-5 bg-slate-900/50 border-t border-slate-700 flex justify-end space-x-3">
                ...
                <button type="submit" class="py-2 px-4 rounded-lg bg-blue-500 hover:bg-blue-600 text-sm font-semibold text-white flex items-center">
                    <svg class="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>
                    Criar Cliente
                </button>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Update clientes count dynamically
            const updateClientesCount = () => {
                const clientesList = document.getElementById('clientes-list-body');
                const countElement = document.getElementById('clientes-count');
                if (clientesList && countElement) {
                    const count = clientesList.querySelectorAll('tr').length;
